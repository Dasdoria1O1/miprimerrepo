	...
	while(opcion!=0){
		...
		switch(opcion){
			case 1:
				...
				cin >> valor_2;
				rta = valor_1 + valor_2;
				cout<<"el resultado de la suma de los valores: "<<valor_1<<" + "<<valor_2<<" es igual a: "<<rta<<"\n";
				break;
			case 2:
				...
				cin >> valor_2;
				rta = valor_1 - valor_2;
				cout<<"el resultado de la resta de los valores: "<<valor_1<<" - "<<valor_2<<" es igual a: "<<rta<<"\n";
				break;
			case 3:
				...
				cin >> valor_2;
				rta = valor_1 * valor_2;
				cout<<"el resultado de la multiplicación de los valores: "<<valor_1<<" X "<<valor_2<<" es igual a: "<<rta<<"\n";
				break;
			case 4:
				...
				rta_division = a/b;
				cout<<"el resultado de la división de los valores: "<<a<<" / "<<b<<" es igual a: "<<rta_division<<"\n";
				break;
			case 0:
